  ...
  return (
    <div className="w-[300px] min-w-[300px] bg-white rounded-lg overflow-hidden shadow-md">
      ...
      <div className="p-4">
        ...
        <button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors">
